...
while=try(
 do{
  string "while"; spaces; char '('; spaces; xs<-identifier; spaces; char ')'; spaces;
  char '{'; spaces; ks<-parser4; spaces; char '}';
  return (WHI,xs,Nodes ks)
  })
  
read_=try(
 do{
  string "read"; spaces; char '(';spaces;xs<-identifier;spaces;char ')'; spaces; char ';';
  return (REA,xs,None)
  })
  
write=try(
 do{
  string "write"; spaces; char '(';spaces;xs<-identifier;spaces;char ')'; spaces; char ';';
  return (WRI,xs,None)
  })
