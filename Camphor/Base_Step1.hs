...
{- C macro -}
step1 :: Includers -> FilePath -> Txt -> Either ParseError Txt
step1 includers file str = parse parser1' (file ++ "--step1") (str ++ "\n") >>= convert1 file includers

-- PARSING
data Pre7 = 
 IFDEF Ident | IFNDEF Ident | 
 UNDEF Ident | ENDIF | ELSE | 
 IF0 | IF1 | OTHER String | 
